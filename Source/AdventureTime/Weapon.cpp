...
void AWeapon::Equip(AMainCharacter* Char)
{
	if (Char)
	{
		...
		const USkeletalMeshSocket* RightHandWeaponSocket = Char->GetMesh()->GetSocketByName("RightHandWeaponSocket");
		if (RightHandWeaponSocket)
		{
			RightHandWeaponSocket->AttachActor(this, Char->GetMesh());
			bRotate = false;
			Char->SetEquippedWeapon(this);
			WeaponState = EWeaponState::EWS_Equipped;
			Char->SetActiveOverlappedItem(nullptr);
		}
